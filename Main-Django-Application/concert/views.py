...
def songs(request):
    url = 'http://songs-sn-labs-erturkmemmed.labs-prod-openshift-san-a45631dc5778dc6371c67d206ba9ae5c-0000.us-east.containers.appdomain.cloud/'
    songs = req.get(url+'song').json()
    return render(request, "songs.html", songs)


def photos(request):
    url = 'https://pictures.1axjz9ueciri.us-south.codeengine.appdomain.cloud/'
